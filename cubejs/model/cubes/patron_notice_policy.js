cube(`patron_notice_policy`, {
  sql_table: `kware_mod_circulation_storage.patron_notice_policy`,
  ...
  dimensions: {
    ...
    loannotices: {
      sql: `${CUBE}.jsonb->>'loanNotices'`,
      type: `string`,
    },
    feefinenotices: {
      sql: `${CUBE}.jsonb->>'feeFineNotices'`,
      type: `string`,
    },
    requestnotices: {
      sql: `${CUBE}.jsonb->>'requestNotices'`,
      type: `string`,
    },
