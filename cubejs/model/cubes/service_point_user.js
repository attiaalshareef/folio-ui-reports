cube(`service_point_user`, {
  sql_table: `kware_mod_inventory_storage.service_point_user`,

  data_source: `default`,

  joins: {
    service_point: {
      sql: `${CUBE}.defaultservicepointid = ${service_point}.id`,
  ...
  dimensions: {
    ...
    servicepointsids: {
      sql: `${CUBE}.jsonb->>'servicePointsIds'`,
      type: `string`,
    },
