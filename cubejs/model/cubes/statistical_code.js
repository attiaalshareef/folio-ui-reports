cube(`statistical_code`, {
  sql_table: `kware_mod_inventory_storage.statistical_code`,

  data_source: `default`,

  joins: {
    statistical_code_type: {
      sql: `${CUBE}.statisticalcodetypeid = ${statistical_code_type}.id`,
  ...
  dimensions: {
    ...
    statisticalcodetypeid: {
      sql: `${CUBE}.jsonb->>'statisticalCodeTypeId'`,
      type: `string`,
    },
    code: {
      sql: `${CUBE}.jsonb->>'code'`,
