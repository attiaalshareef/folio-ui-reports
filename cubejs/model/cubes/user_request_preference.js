cube(`user_request_preference`, {
  sql_table: `kware_mod_circulation_storage.user_request_preference`,
  ...
  dimensions: {
    ...
    holdshelf: {
      sql: `${CUBE}.jsonb->>'holdShelf'`,
      type: `boolean`,
    },
    fulfillment: {
      sql: `${CUBE}.jsonb->>'fulfillment'`,
      type: `string`,
    },
    defaultservicepointid: {
      sql: `${CUBE}.jsonb->>'defaultServicePointId'`,
      type: `string`,
    },
